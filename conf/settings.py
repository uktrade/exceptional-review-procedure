...
COMMODITY_NAME_SEARCH_API_ENDPOINT = env.str('COMMODITY_NAME_SEARCH_API_ENDPOINT')
HIERARCHY_BROWSER_LOOKUP_API_ENDPOINT = env.str('HIERARCHY_BROWSER_LOOKUP_API_ENDPOINT')
