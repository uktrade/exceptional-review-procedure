...
def test_business_end_to_end(
    ...
    assert mock_zendesk_action().save.call_args == mock.call({
        ...
        'family_name': 'Example',
        'email': 'jim@example.com',
        'user_type': 'As a UK business or trade organisation',
    })
...
def test_consumer_end_to_end(
    ...
    assert mock_zendesk_action().save.call_args == mock.call({
        ...
        'user_type': 'As a UK consumer or consumer representative',
    })
...
def test_developing_country_business_end_to_end(
    ...
    assert mock_zendesk_action().save.call_args == mock.call({
        ...
        'email': 'jim@example.com',
        'user_type': (
            'As an exporter, or representative, from a developing country eligible for the '
            'Generalised Scheme of Preferences (GSP) or with an Economic Partnership Agreement '
            '(EPA) with the UK.'
        ),
    })
...
def test_importer_end_to_end(
    ...
    assert mock_zendesk_action().save.call_args == mock.call({
        ...
        'family_name': 'Example',
        'email': 'jim@example.com',
        'user_type': 'As a UK business or trade organisation (importer)',
    })
